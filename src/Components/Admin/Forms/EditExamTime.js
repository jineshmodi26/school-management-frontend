...
export default function EditExamTime(props) {
    ...
    const [startime,setStartTime] = React.useState(props.ExamTime.startTime);
    const [startimeFlag,setStartTimeFlag] = React.useState(true);
    const [endtime,setEndTime] = React.useState(props.ExamTime.endTime);
    const [endtimeFlag,setEndTimeFlag] = React.useState(true);
    const [examDate,setExamDate] = React.useState(new Date(props.ExamTime.date.substring(0, 10)));
    const [examDateFlag,setExamDateFlag] = React.useState(true);
    const [subjectList, setSubjectList] = useState([]);
    const [subject, setSubject] = React.useState(props.ExamTime.subject);
    ...
    const submitExamtimeHandler = (e)=>{
        ...
        props.HandleEditExamTimeList(obj);
    }
    useEffect(() => {
        axios({
            method : "GET",
